...
library(pacman)
pacman::p_load(httr, remotes, tidyverse,rvest,jsonlite,plotly,BatchGetSymbols,shinydashboard,shiny,shinycustomloader,
              shinydashboardPlus,waiter,shinyWidgets,dashboardthemes,quantmod,PerformanceAnalytics,reshape2,viridis,
              shinyjqui,DT,lubridate,robustbase,shinyBS,cluster,huge,qgraph,magic,shinyFeedback,tmap)
if (!require("shinypop")) remotes::install_github("dreamRs/shinypop", force = TRUE)
source('Functions.R')
