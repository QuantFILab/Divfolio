...
# }
# sapply(list.package, package.check)
...
Marupanthorn, Pasin and Sklibosios Nikitopoulos, Christina and Ofosu-Hene, Eric and Peters, Gareth and Richards, Kylie-Anne and Richards, Kylie-Anne, Mechanisms to Incentivise Fossil Fuel Divestment and Implications on Portfolio Risk and Returns (June 8, 2022). Available at SSRN: https://ssrn.com/abstract=4131449 or http://dx.doi.org/10.2139/ssrn.4131449. The comparison of performances to the non-divest portfolio will be given in the STEP 5.")),
                        ...
                        tabPanel(title = "Packages and Dependency",
                                 ...
                                 HTML("<!-- html table generated in R 4.1.2 by xtable 1.8-4 package -->
<!-- Fri Sep 02 23:22:43 2022 -->
<table border=1>
<tr> <th> Package </th> <th> Version </th> <th> Description </th>  </tr>
  <tr> <td> BatchGetSymbols </td> <td> 2.6.4 </td> <td> Makes it easy to download financial data from Yahoo Finance &lt;https://finance.yahoo.com/&gt;. </td> </tr>
  <tr> <td> cluster </td> <td> 2.1.2 </td> <td> Methods for Cluster analysis.  Much extended the original from
	Peter Rousseeuw, Anja Struyf and Mia Hubert,
	based on Kaufman and Rousseeuw (1990) "Finding Groups in Data". </td> </tr>
  <tr> <td> dashboardthemes </td> <td> 1.1.5 </td> <td> Allows manual creation of themes and logos to be used in
    ...
    functions. </td> </tr>
  <tr> <td> DT </td> <td> 0.23 </td> <td> Data objects in R can be rendered as HTML tables using the
    JavaScript library 'DataTables' (typically via R Markdown or Shiny). The
    'DataTables' library has been included in this R package. The package name
    'DT' is an abbreviation of 'DataTables'. </td> </tr>
  <tr> <td> huge </td> <td> 1.3.5 </td> <td> Provides a general framework for
        ...
        for the graphical lasso. </td> </tr>
  <tr> <td> lubridate </td> <td> 1.8.0 </td> <td> Functions to work with date-times and time-spans:
    ...
    more details. </td> </tr>
  <tr> <td> magic </td> <td> 1.6.0 </td> <td> A collection of functions for the manipulation and
 ...
 high-dimensional magic hypercubes. </td> </tr>
  <tr> <td> PerformanceAnalytics </td> <td> 2.0.4 </td> <td> Collection of econometric functions for performance and risk 
    ...
    numbers of functions will work with P&amp;L or price data where possible. </td> </tr>
  <tr> <td> plotly </td> <td> 4.10.0 </td> <td> Create interactive web graphics from 'ggplot2' graphs and/or a custom interface to the (MIT-licensed) JavaScript library 'plotly.js' inspired by the grammar of graphics. </td> </tr>
  <tr> <td> qgraph </td> <td> 1.9.2 </td> <td> Weighted network visualization and analysis, as well as Gaussian graphical model computation. See Epskamp et al. (2012) &lt;doi:10.18637/jss.v048.i04&gt;. </td> </tr>
  <tr> <td> quantmod </td> <td> 0.4.20 </td> <td> Specify, build, trade, and analyse quantitative financial trading strategies. </td> </tr>
  <tr> <td> reshape2 </td> <td> 1.4.4 </td> <td> Flexibly restructure and aggregate data using just two
    functions: melt and 'dcast' (or 'acast'). </td> </tr>
  <tr> <td> robustbase </td> <td> 0.95.0 </td> <td> "Essential" Robust Statistics.
 ...
 Theory and Methods" by 'Maronna, Martin and Yohai'; Wiley 2006. </td> </tr>
  <tr> <td> rvest </td> <td> 1.0.2 </td> <td> Wrappers around the 'xml2' and 'httr' packages to
    make it easy to download, then manipulate, HTML and XML. </td> </tr>
  <tr> <td> shiny </td> <td> 1.7.1 </td> <td> Makes it incredibly easy to build interactive web
    applications with R. Automatic "reactive" binding between inputs and
    outputs and extensive prebuilt widgets make it possible to build
    beautiful, responsive, and powerful applications with minimal effort. </td> </tr>
  <tr> <td> shinyBS </td> <td> 0.61.1 </td> <td> Adds additional Twitter Bootstrap components to Shiny.  </td> </tr>
  <tr> <td> shinycustomloader </td> <td> 0.9.0 </td> <td> A custom css/html or gif/image file for the loading screen in R 'shiny'. It also can use the marquee to have custom text loading screen.  </td> </tr>
  <tr> <td> shinydashboard </td> <td> 0.7.2 </td> <td> Create dashboards with 'Shiny'. This package provides
    a theme on top of 'Shiny', making it easy to create attractive dashboards. </td> </tr>
  <tr> <td> shinydashboardPlus </td> <td> 2.0.3 </td> <td> Extend 'shinydashboard' with 'AdminLTE2' components. 
             'AdminLTE2' is a free 'Bootstrap 3' dashboard template available
             at &lt;https://adminlte.io&gt;. Customize boxes, add timelines and a lot more.  </td> </tr>
  <tr> <td> shinyFeedback </td> <td> 0.4.0 </td> <td> Easily display user feedback in Shiny apps. </td> </tr>
  <tr> <td> shinyjqui </td> <td> 0.4.1 </td> <td> An extension to shiny that brings interactions and animation effects from
    'jQuery UI' library. </td> </tr>
  <tr> <td> shinypop </td> <td> 0.1.1 </td> <td> Custom notifications, confirm dialogs and alerts for 'Shiny' applications. </td> </tr>
  <tr> <td> shinyWidgets </td> <td> 0.6.4 </td> <td> Collection of custom input controls and user interface components for 'Shiny' applications. 
  Give your applications a unique and colorful style ! </td> </tr>
  <tr> <td> tidyverse </td> <td> 1.3.1 </td> <td> The 'tidyverse' is a set of packages that work in harmony
    ...
    'tidyverse' at &lt;https://www.tidyverse.org&gt;. </td> </tr>
  <tr> <td> viridis </td> <td> 0.6.2 </td> <td> Color maps designed to improve graph readability for readers with 
    ...
    &lt;https://cran.r-project.org/package=viridisLite&gt;. </td> </tr>
  <tr> <td> waiter </td> <td> 0.2.5 </td> <td> Full screen and partial loading screens for 'Shiny' with spinners, progress bars, and notifications. </td> </tr>
   </table>")
...
# F100 <- F100 %>% filter(Sector %in% c('Energy','Utilities','Healthcare'))
